                      ...
                      child: CustomScrollView(
                        slivers: [
                          ...
                          _PlaylistActionButtons(
                              time: state.playlist.time, cover: cover),
...
class _PlaylistActionButtons extends StatefulWidget {
  const _PlaylistActionButtons({required this.time, required this.cover});
  final String time;
  final String cover;
  @override
                ...
                child: Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                       if(_isLiked == false){
                         context.read<FavoritePlaylistCubit>().addPlaylist(widget.cover);
                        }else{
                          context.read<FavoritePlaylistCubit>().removePlaylist(widget.cover);
                        }
                    ...
                    GestureDetector(
                      onTap: () {
                        Share.share('Hãy vào nghe nhạc này đi https://example.com');
